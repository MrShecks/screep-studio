...
class CreepRenderer1 {

    static const int CREEP_BODY_RADIUS          = 80;       // Percentage of total radius
...
public:
    ...
    CreepRenderer1& setJson(const QJsonArray& json);

    void reset();

    void draw(QPainter* painter, qreal size, qreal angle = 0);

    static CreepRenderer1 fromJson(const QJsonArray& json);
...
private:
    ...
    void drawBodyPart(QPainter* painter, const QRectF& rect, QColor color, qreal size, qreal lineWidth, bool isBackendPart);
