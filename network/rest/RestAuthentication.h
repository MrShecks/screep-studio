...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// RestRequestAuthMod (HTTP GET)
// Request information about the screepsmode-auth server mod
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////

class RestRequestAuthMod : public RESTRequestBuilder {
    typedef RESTRequestBuilder _super;

public:
    RestRequestAuthMod()
        : _super (Screeps::PATH_AUTHMOD) {

    }

    virtual ~RestRequestAuthMod() {
...
class RestAuthModVersion {
public:

    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class Request : public RESTRequestBuilder {
        typedef RESTRequestBuilder _super;

    public:
        Request() : _super(Screeps::PATH_AUTHMOD) {
    ...
    class Response : public RestResponse {
        typedef RestResponse _super;

    public:
        Response(const RestResponse& response) : _super(response) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// RestRequestTicketSignin (HTTP POST)
